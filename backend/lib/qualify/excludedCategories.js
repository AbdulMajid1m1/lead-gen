...
const NAME_RULES = [
  ...
  { category: "ALCOHOL", re: /\b(?:whisk(?:e)?y|vodka|gin|rum|tequila|bourbon|brandy|cognac|champagne|prosecco|lager|ale|stout|cider|mead|sake|absinthe|liqueur)\b(?!\s*-?free)/i, needsContext: true },
